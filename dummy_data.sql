...
('partner_1', 'part_firebase_789', 'La Sqala Restaurant Group', 'Boulevard des Almohades, Casablanca', 'https://www.sqala.ma', '{"instagram": "lasqalaofficiel", "facebook": "LaSqala"}', NOW(), NOW()),
('partner_2', 'part_firebase_abc', 'Casablanca Tourism & Events', '123 Avenue Mohammed V, Casablanca', 'https://www.casatourisme.ma', '{"twitter": "casatourisme", "facebook": "CasaTourisme"}', NOW(), NOW());
...
('sched_5', 'listing_3', '2025-07-17T09:30:00Z', '2025-07-17T12:00:00Z', 0.00, 'MAD', 25, true),
('sched_6', 'listing_3', '2025-07-17T14:00:00Z', '2025-07-17T18:30:00Z', 0.00, 'MAD', 25, true),
('sched_7', 'listing_3', '2025-07-18T09:30:00Z', '2025-07-18T12:00:00Z', 0.00, 'MAD', 25, true),
('sched_8', 'listing_3', '2025-07-18T14:00:00Z', '2025-07-18T18:30:00Z', 0.00, 'MAD', 25, true);
...
('booking_1', 'cust_firebase_123', 'listing_1', 'sched_1', 2, 700.00, 'CONFIRMED', NOW(), NOW()),
('booking_2', 'cust_firebase_456', 'listing_2', 'sched_2', 1, 130.00, 'CONFIRMED', NOW(), NOW()),
('booking_3', 'cust_firebase_123', 'listing_2', 'sched_3', 4, 520.00, 'PENDING', NOW(), NOW()),
('booking_4', 'cust_firebase_456', 'listing_4', 'sched_4', 2, 1000.00, 'AWAITING_PAYMENT', NOW(), NOW());
...
('payment_1', 'booking_1', 'cust_firebase_123', 700.00, 'MAD', 'SUCCEEDED', 'Stripe', 'pi_1', NOW(), NOW()),
('payment_2', 'booking_2', 'cust_firebase_456', 130.00, 'MAD', 'SUCCEEDED', 'CMI', 'cmi_2', NOW(), NOW());
...
('review_1', 'cust_firebase_123', 'listing_1', 'booking_1', 5, 'Absolutely magical experience! The food was divine and the garden is an oasis in the city.', 'Thank you for your kind words! We are delighted you enjoyed your evening at La Sqala.', NOW(), NOW()),
('review_2', 'cust_firebase_456', 'listing_2', 'booking_2', 4, 'The mosque is breathtaking. The tour was very informative but felt a little rushed.', NULL, NOW(), NOW());
...
('cust_firebase_123', 'listing_3', NOW()),
('cust_firebase_123', 'listing_4', NOW()),
('cust_firebase_456', 'listing_1', NOW());

-- 13. NOTIFICATIONS
-- System notifications for users.
INSERT INTO "notifications" (id, "user_id", type, title, message, "is_read", "related_booking_id", "created_at") VALUES
('notif_1', 'part_firebase_789', 'NEW_BOOKING_REQUEST', 'New Reservation', 'You have a new reservation for La Sqala for 2 people.', false, 'booking_1', NOW()),
('notif_2', 'cust_firebase_123', 'BOOKING_CONFIRMED', 'Reservation Confirmed!', 'Your booking at La Sqala for 2 people has been confirmed.', false, 'booking_1', NOW()),
('notif_3', 'cust_firebase_456', 'RESERVATION_REMINDER', 'Reminder: Hassan II Mosque Tour', 'Your guided tour is tomorrow at 10:00 AM. Don''t forget your ticket!', false, 'booking_2', NOW());

INSERT INTO "listing_daily_stats" ("listing_id", "stat_date", "view_count", "booking_count") VALUES
-- La Sqala is popular
('listing_1', NOW() - INTERVAL '1 day', 150, 5),
('listing_1', NOW() - INTERVAL '2 day', 120, 2),
-- Hassan II Mosque gets a lot of views and bookings
('listing_2', NOW() - INTERVAL '1 day', 250, 10),
('listing_2', NOW() - INTERVAL '3 day', 200, 8),
-- Villa des Arts gets views but no bookings in our mock data
('listing_3', NOW() - INTERVAL '2 day', 80, 0),
-- Rick's Cafe gets views and one awaiting payment booking
('listing_4', NOW() - INTERVAL '1 day', 180, 1);